...
Begin VB.Form frmSalesOrderDelivery 
   ...
   End
End
Attribute VB_Name = "frmSalesOrderDelivery"
...
Dim rsSalesOrderDelivery As New Recordset
...
Public Sub CommandPass(ByVal srcPerformWhat As String)
    ...
    Select Case srcPerformWhat
        Case "New"
            frmSalesOrderDeliveryAE.State = adStateAddMode
            frmSalesOrderDeliveryAE.show vbModal
        Case "Edit"
            If lvList.ListItems.Count > 0 Then
                If isRecordExist("Sales_Order_Delivery", "DeliveryID", CLng(LeftSplitUF(lvList.SelectedItem.Tag))) = False Then
        ...
        Case "Delete"
            If lvList.ListItems.Count > 0 Then
                ...
                Else
                    ...
                    If ANS = vbYes Then
                        'Remove
                        DelRecwSQL "Sales_Order_Delivery", "DeliveryID", "", True, CLng(LeftSplitUF(lvList.SelectedItem.Tag))
                        'Refresh the records
                        RefreshRecords
...
Private Sub Form_Load()
    ...
    With SQLParser
        .Fields = "SONo, Company, DeliveryNo, DeliveryDate, QtyRcvd, Returned, DeliveryID"
        .Tables = "qry_Sales_Order_Delivery"
        .SortOrder = "DeliveryDate DESC"
        
        .SaveStatement
    End With
    
    rsSalesOrderDelivery.CursorLocation = adUseClient
    rsSalesOrderDelivery.Open SQLParser.SQLStatement, CN, adOpenStatic, adLockReadOnly
    
    With RecordPage
        .Start rsSalesOrderDelivery, 75
        FillList 1
    End With
...
Private Sub FillList(ByVal whichPage As Long)
    ...
    Me.Enabled = False
    Call pageFillListView(lvList, rsSalesOrderDelivery, RecordPage.PageStart, RecordPage.PageEnd, 16, 2, False, True, , , , "DeliveryID")
    Me.Enabled = True
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    Set frmSalesOrderDelivery = Nothing
End Sub
