...
Begin VB.Form frmPurchaseOrderReceive 
   ...
   End
End
Attribute VB_Name = "frmPurchaseOrderReceive"
...
Public Sub CommandPass(ByVal srcPerformWhat As String)
    ...
    Select Case srcPerformWhat
        Case "New"
            frmPurchaseOrderReceiveAE.State = adStateAddMode
            frmPurchaseOrderReceiveAE.show vbModal
        Case "Edit"
            If lvList.ListItems.Count > 0 Then
                If isRecordExist("Purchase_Order_Receive", "InvoiceID", CLng(LeftSplitUF(lvList.SelectedItem.Tag))) = False Then
        ...
        Case "Delete"
            If lvList.ListItems.Count > 0 Then
                ...
                Else
                    ...
                    If ANS = vbYes Then
                        'Remove
                        DelRecwSQL "Purchase_Order_Receive", "InvoiceID", "", True, CLng(LeftSplitUF(lvList.SelectedItem.Tag))
                        'Refresh the records
                        RefreshRecords
...
Private Sub Form_Load()
    ...
    With SQLParser
        .Fields = "PONo, Company, InvoiceNo, InvoiceDate, QtyRcvd, Returned, InvoiceID"
        .Tables = "qry_Purchase_Order_Receive"
...
Private Sub FillList(ByVal whichPage As Long)
    ...
    Me.Enabled = False
    Call pageFillListView(lvList, rsLocalPurchase, RecordPage.PageStart, RecordPage.PageEnd, 16, 2, False, True, , , , "InvoiceID")
    Me.Enabled = True
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    Set frmPurchaseOrderReceive = Nothing
End Sub
