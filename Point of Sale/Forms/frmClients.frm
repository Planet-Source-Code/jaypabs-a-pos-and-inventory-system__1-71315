...
Public Sub CommandPass(ByVal srcPerformWhat As String)
    ...
    Select Case srcPerformWhat
        Case "New"
            frmClientsAE.State = adStateAddMode
            frmClientsAE.show vbModal
        Case "Edit"
...
Private Sub Form_Load()
    ...
    With SQLParser
        .Fields = "AccountNo, Company, Tin, CategoryID, CreditLimit, Lastname, Firstname, Gender, Address, Mobile, Landline, Fax, Email, Website, StartingBalance, ClientID"
        .Tables = "Clients"
    ...
    rsClients.Open SQLParser.SQLStatement, CN, adOpenStatic, adLockReadOnly
...
Private Sub FillList(ByVal whichPage As Long)
    ...
    Me.Enabled = False
    Call pageFillListView(lvList, rsClients, RecordPage.PageStart, RecordPage.PageEnd, 15, 2, False, True, , , , "ClientID")
    Me.Enabled = True
