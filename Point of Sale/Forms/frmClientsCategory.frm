...
Begin VB.Form frmClientsCategory 
   ...
   End
End
Attribute VB_Name = "frmClientsCategory"
...
Dim rsClients_Category As New Recordset
...
Public Sub CommandPass(ByVal srcPerformWhat As String)
    ...
    Select Case srcPerformWhat
        Case "New"
            frmClientsCategoryAE.State = adStateAddMode
            frmClientsCategoryAE.show vbModal
        Case "Edit"
            If lvList.ListItems.Count > 0 Then
                If isRecordExist("Clients_Category", "CategoryID", CLng(LeftSplitUF(lvList.SelectedItem.Tag))) = False Then
                    MsgBox "This record has been removed by other user.Click 'OK' button to refresh the records.", vbExclamation
                    RefreshRecords
                    Exit Sub
                Else
                    With frmClientsCategoryAE
        ...
        Case "Delete"
            If lvList.ListItems.Count > 0 Then
                ...
                Else
                    ...
                    If ANS = vbYes Then
                        DelRecwSQL "Clients_Category", "CategoryID", "", True, CLng(LeftSplitUF(lvList.SelectedItem.Tag))
                        RefreshRecords
...
Private Sub Form_Load()
    ...
    With SQLParser
        ...
        .Tables = "Clients_Category"
        .SortOrder = "Category ASC"
        
        .SaveStatement
    End With
    rsClients_Category.CursorLocation = adUseClient
    rsClients_Category.Open SQLParser.SQLStatement, CN, adOpenStatic, adLockReadOnly
    
    With RecordPage
        .Start rsClients_Category, 75
        FillList 1
    End With
...
Private Sub FillList(ByVal whichPage As Long)
    ...
    Me.Enabled = False
    Call pageFillListView(lvList, rsClients_Category, RecordPage.PageStart, RecordPage.PageEnd, 2, 2, False, True, , , , "CategoryID")
    Me.Enabled = True
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    Set frmClientsCategory = Nothing
End Sub
