...
Begin VB.Form frmLocalPurchase 
   ...
   End
End
Attribute VB_Name = "frmLocalPurchase"
...
Public Sub CommandPass(ByVal srcPerformWhat As String)
    ...
    Select Case srcPerformWhat
        Case "New"
            frmLocalPurchaseAE.State = adStateAddMode
            frmLocalPurchaseAE.show vbModal
        Case "Edit"
            If lvList.ListItems.Count > 0 Then
                If isRecordExist("Local_Purchase", "LocalPurchaseID", CLng(LeftSplitUF(lvList.SelectedItem.Tag))) = False Then
                    MsgBox "This record has been removed by other user. Click 'OK' button to refresh the records.", vbExclamation
                    RefreshRecords
                    Exit Sub
                Else
                    With frmLocalPurchaseAE
        ...
        Case "Delete"
            If lvList.ListItems.Count > 0 Then
                ...
                Else
                    ...
                    If ANS = vbYes Then
                        'Remove
                        DelRecwSQL "Local_Purchase", "LocalPurchaseID", "", True, CLng(LeftSplitUF(lvList.SelectedItem.Tag))
                        'Refresh the records
                        RefreshRecords
...
Private Sub Form_Load()
    ...
    With SQLParser
        .Fields = "Date, InvoiceNo, PurchaseFrom, PaymentType, Gross, Discount, NetAmount, LocalPurchaseID"
        .Tables = "Local_Purchase"
        .SortOrder = "Date DESC"
...
Private Sub FillList(ByVal whichPage As Long)
    ...
    Me.Enabled = False
    Call pageFillListView(lvList, rsLocalPurchase, RecordPage.PageStart, RecordPage.PageEnd, 16, 2, False, True, , , , "LocalPurchaseID")
    Me.Enabled = True
