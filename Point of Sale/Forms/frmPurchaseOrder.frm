...
Public Sub CommandPass(ByVal srcPerformWhat As String)
    ...
    Select Case srcPerformWhat
        Case "New"
            frmPurchaseOrderAE.State = adStateAddMode
            frmPurchaseOrderAE.show vbModal
        Case "Edit"
            If lvList.ListItems.Count > 0 Then
                If isRecordExist("Purchase_Order", "PurchaseOrderID", CLng(LeftSplitUF(lvList.SelectedItem.Tag))) = False Then
                    MsgBox "This record has been removed by other user. Click 'OK' button to refresh the records.", vbExclamation
                    RefreshRecords
                    Exit Sub
                Else
                    With frmPurchaseOrderAE
        ...
        Case "Delete"
            If lvList.ListItems.Count > 0 Then
                ...
                Else
                    ...
                    If ANS = vbYes Then
                        'Remove
                        DelRecwSQL "Purchase_Order", "PurchaseOrderID", "", True, CLng(LeftSplitUF(lvList.SelectedItem.Tag))
                        'Refresh the records
                        RefreshRecords
...
Private Sub Form_Load()
    ...
    With SQLParser
        .Fields = "PONo, Company, Date, Salesman, QtyOrdered, QtyRcvd, QtyDue, PurchaseOrderID"
        .Tables = "qry_Purchase_Order"
        .SortOrder = "Date DESC"
    ...
    rsPurchaseOrder.Open SQLParser.SQLStatement, CN, adOpenStatic, adLockReadOnly
    
    With RecordPage
        .Start rsPurchaseOrder, 75
        FillList 1
    End With
...
Private Sub FillList(ByVal whichPage As Long)
    ...
    Me.Enabled = False
    Call pageFillListView(lvList, rsPurchaseOrder, RecordPage.PageStart, RecordPage.PageEnd, 16, 2, False, True, , , , "PurchaseOrderID")
    Me.Enabled = True
