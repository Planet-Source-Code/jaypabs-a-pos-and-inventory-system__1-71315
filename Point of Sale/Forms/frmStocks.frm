...
Public Sub CommandPass(ByVal srcPerformWhat As String)
    ...
    Select Case srcPerformWhat
        Case "New"
            frmStocksAE.State = adStateAddMode
            frmStocksAE.show vbModal
        Case "Edit"
            If lvList.ListItems.Count > 0 Then
                If isRecordExist("Stocks", "StockID", CLng(LeftSplitUF(lvList.SelectedItem.Tag))) = False Then
        ...
        Case "Delete"
            If lvList.ListItems.Count > 0 Then
                ...
                Else
                    ...
                    If ANS = vbYes Then
                        DelRecwSQL "Stocks", "StockID", "", True, CLng(LeftSplitUF(lvList.SelectedItem.Tag))
                        RefreshRecords
...
Private Sub Form_Load()
    ...
    With SQLParser
        .Fields = "Barcode, Stock, Short1, Short2, ICode, SalesPrice, Cost, ReorderPoint,  Category, StockID"
        .Tables = "qry_Stocks"
        .SortOrder = "Stock ASC"
...
Private Sub FillList(ByVal whichPage As Long)
    ...
    Me.Enabled = False
    Call pageFillListView(lvList, RSStocks, RecordPage.PageStart, RecordPage.PageEnd, 15, 2, False, True, , , , "StockID")
    Me.Enabled = True
...
Private Sub lvList_KeyDown(KeyCode As Integer, Shift As Integer)
  If KeyCode = 46 Then CommandPass "Delete"
End Sub
