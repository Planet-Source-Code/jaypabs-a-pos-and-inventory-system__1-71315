...
Begin VB.Form frmLocalPurchaseReturnAE 
   BorderStyle     =   0  'None
   Caption         =   "Form1"
   ClientHeight    =   9030
   ClientLeft      =   0
   ...
   Begin VB.CommandButton btnRemove 
      Height          =   275
      Left            =   300
      Picture         =   "frmLocalPurchaseReturnAE.frx":0000
      Style           =   1  'Graphical
      TabIndex        =   8
      ToolTipText     =   "Remove"
      Top             =   3390
   ...
   Begin VB.TextBox txtPurchaseFrom 
      ...
      Width           =   2475
   End
   Begin VB.TextBox txtPuchaseRequest 
      Height          =   285
      Left            =   1740
      Locked          =   -1  'True
      TabIndex        =   1
   ...
   End
End
Attribute VB_Name = "frmLocalPurchaseReturnAE"
...
Private Sub cmdPrintPreview_Click()
    With frmReports
        .strReport = "Local Purchase Return"
        .strWhere = "{Local_Purchase_Return.VoucherID} =" & PK
...
Private Sub cmdSave_Click()
  ...
  End If
    ...
    RSReturn.Open "Local_Purchase_Return", CN, adOpenDynamic, adLockOptimistic, adCmdTable

    'Connection for Local_Purchase_Return_Detail
    Dim RSDetails As New Recordset

    RSDetails.CursorLocation = adUseClient
    RSDetails.Open "Local_Purchase_Return_Detail", CN, adOpenDynamic, adLockOptimistic, adCmdTable
    ...
    With RSReturn
        ...
        VoucherPK = getIndex("Local_Purchase_Return")
        ![VoucherID] = VoucherPK
        ![LocalPurchaseID] = PK
    ...
    With Grid
        ...
        Dim RSLocalPurchaseDetails As New Recordset
    
        RSLocalPurchaseDetails.CursorLocation = adUseClient
        RSLocalPurchaseDetails.Open "SELECT * From Local_Purchase_Detail Where LocalPurchaseID = " & PK, CN, , adLockOptimistic
...
'            RSStocks.Update
            ...
            RSLocalPurchaseDetails.Find "[StockID] = " & toNumber(.TextMatrix(c, 10)), , adSearchForward, 1
            RSLocalPurchaseDetails!QtyReturned = toNumber(RSLocalPurchaseDetails!QtyReturned) + toNumber(.TextMatrix(c, 4))
            
            RSLocalPurchaseDetails.Update
        Next c
    End With
...
Private Sub Form_Load()
    ...
    Else
        ...
        rs.Open "SELECT * FROM qry_Local_Purchase_Return WHERE VoucherID=" & PK, CN, adOpenStatic, adLockOptimistic
...
Private Sub Form_Unload(Cancel As Integer)
    Set frmLocalPurchaseReturnAE = Nothing
End Sub
...
Private Sub DisplayForEditing()
    ...
    txtPuchaseRequest.Text = rs![PurchaseRequestNo]
...
Private Sub DisplayForViewing()
    ...
    RSDetails.CursorLocation = adUseClient
    RSDetails.Open "SELECT * FROM qry_Local_Purchase_Return_Detail WHERE VoucherID=" & PK & " ORDER BY Stock ASC", CN, adOpenStatic, adLockOptimistic
    If RSDetails.RecordCount > 0 Then
        RSDetails.MoveFirst
        While Not RSDetails.EOF
            With Grid
