...
Begin VB.Form frmPurchaseOrderReturn 
   ...
   Begin VB.Label lblTitle 
      BackStyle       =   0  'Transparent
      Caption         =   "Purchase Return History"
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   8.25
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmPurchaseOrderReturn"
...
Dim rsLocalPurchase As New Recordset
...
Public Sub CommandPass(ByVal srcPerformWhat As String)
    ...
    Select Case srcPerformWhat
        Case "New"
            frmPurchaseOrderReturnAE.State = adStateAddMode
            frmPurchaseOrderReturnAE.show vbModal
        Case "Edit"
            If lvList.ListItems.Count > 0 Then
                If isRecordExist("Purchase_Order_Return", "PurchaseOrderReturnID", CLng(LeftSplitUF(lvList.SelectedItem.Tag))) = False Then
        ...
        Case "Delete"
            If lvList.ListItems.Count > 0 Then
                ...
                Else
                    ...
                    If ANS = vbYes Then
                        'Remove
                        DelRecwSQL "Purchase_Order_Return", "PurchaseOrderReturnID", "", True, CLng(LeftSplitUF(lvList.SelectedItem.Tag))
                        'Refresh the records
                        RefreshRecords
...
Private Sub Form_Load()
    ...
    With SQLParser
        .Fields = "PONo, Company, InvoiceNo, DebitMemoNo, DebitMemoDate, QtyReturned, PurchaseOrderReturnID"
        .Tables = "qry_Purchase_Order_Return"
        .SortOrder = "InvoiceDate DESC"
        
        .SaveStatement
    End With
    
    rsLocalPurchase.CursorLocation = adUseClient
    rsLocalPurchase.Open SQLParser.SQLStatement, CN, adOpenStatic, adLockReadOnly
    
    With RecordPage
        .Start rsLocalPurchase, 75
        FillList 1
    End With
...
Private Sub FillList(ByVal whichPage As Long)
    ...
    Me.Enabled = False
    Call pageFillListView(lvList, rsLocalPurchase, RecordPage.PageStart, RecordPage.PageEnd, 16, 2, False, True, , , , "PurchaseOrderReturnID")
    Me.Enabled = True
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    Set frmPurchaseOrderReturn = Nothing
End Sub
