...
Begin VB.Form frmCashSalesReturn 
   ...
   End
End
Attribute VB_Name = "frmCashSalesReturn"
...
Dim rsCashSalesReturn As New Recordset
...
Public Sub CommandPass(ByVal srcPerformWhat As String)
    ...
    Select Case srcPerformWhat
        Case "New"
            frmCashSalesReturnAE.State = adStateAddMode
            frmCashSalesReturnAE.show vbModal
        Case "Edit"
            If lvList.ListItems.Count > 0 Then
                If isRecordExist("Cash_Sales_Return", "VoucherID", CLng(LeftSplitUF(lvList.SelectedItem.Tag))) = False Then
        ...
        Case "Delete"
            If lvList.ListItems.Count > 0 Then
                ...
                Else
                    ...
                    If ANS = vbYes Then
                        'Remove
                        DelRecwSQL "Cash_Sales_Return", "VoucherID", "", True, CLng(LeftSplitUF(lvList.SelectedItem.Tag))
                        'Refresh the records
                        RefreshRecords
...
Private Sub Form_Load()
    ...
    With SQLParser
        .Fields = "Date, VoucherNo, InvoiceNo, BusinessName, Address, QtyReturned, Gross, Discount, NetAmount, VoucherID"
        .Tables = "qry_Cash_Sales_Return"
        .SortOrder = "Date DESC"
        
        .SaveStatement
    End With
    
    rsCashSalesReturn.CursorLocation = adUseClient
    rsCashSalesReturn.Open SQLParser.SQLStatement, CN, adOpenStatic, adLockReadOnly
    
    With RecordPage
        .Start rsCashSalesReturn, 75
        FillList 1
    End With
...
Private Sub FillList(ByVal whichPage As Long)
    ...
    Me.Enabled = False
    Call pageFillListView(lvList, rsCashSalesReturn, RecordPage.PageStart, RecordPage.PageEnd, 16, 2, False, True, , , , "VoucherID")
    Me.Enabled = True
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    Set frmCashSalesReturn = Nothing
End Sub
